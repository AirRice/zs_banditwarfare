...
function ENT:StartTouch(ent)
	if self.DieTime ~= 0 and ent:IsPlayer() and ent:Alive() and (ent:Team() == TEAM_BANDIT or ent:Team() == TEAM_HUMAN) and ent.Cannibalistic then
		self.DieTime = 0
		ent:GiveAmmo( 10, "Battery", false )
