...
net.Receive("zs_capture", function(length)
	gamemode.Call("CapturingPoint", net.ReadEntity(), net.ReadUInt(16))
end)
...
local cvarNoFloatingScore = CreateClientConVar("zsb_nofloatingscore", 0, true, false)
