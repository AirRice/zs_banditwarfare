...
WEAPONCLASS_MAGNUMPISTOL = 2
WEAPONCLASS_SPLITPISTOL = 3

WEAPONCLASS_SHOTGUN = 4
WEAPONCLASS_AUTOSHOTGUN = 5

WEAPONCLASS_ASSAULT = 6
WEAPONCLASS_SMG = 7
WEAPONCLASS_ASSAULTSMG = 8

WEAPONCLASS_SNIPER = 9
WEAPONCLASS_MARKSMAN = 10

WEAPONCLASS_CROSSBOW = 11
WEAPONCLASS_BIO = 12
...
WEAPONCLASS_MELEE_BLUNT = 28
WEAPONCLASS_MELEE_BLUNT_FAST = 29
WEAPONCLASS_MELEE_REPAIR = 30
WEAPONCLASS_MELEE_UTIL = 32

-- You can use numbers 32-46 if adding custom weapon types
