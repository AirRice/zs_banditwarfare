...
LANGUAGE.win										= "%s 胜利"
LANGUAGE.draw										= "平局"
LANGUAGE.x_kills_x_deaths                           = "%s 杀/%d 死"
LANGUAGE.x_kills_x_deaths_x_points                  = "%s 杀/%d 死 | %s"

LANGUAGE.itemcategory_guns							= "枪械"
LANGUAGE.itemcategory_ammo							= "弹药"
LANGUAGE.itemcategory_melee							= "近战武器"
LANGUAGE.itemcategory_tools							= "工具"
LANGUAGE.itemcategory_etc							= "其他"
LANGUAGE.select_team								= "更改阵营"
LANGUAGE.playermodel_changed_to_x					= "你的玩家模型已设置为“%s”。"
LANGUAGE.select_playermodel							= "选择玩家模型"
LANGUAGE.random_model								= "随机玩家模型"
LANGUAGE.reset_playermodel_button					= "使用随机玩家模型"
...
LANGUAGE.option_auto_select_team					= "第一次进入游戏时自动选择阵营"
LANGUAGE.option_hide_most_of_hud					= "电影模式（隐藏大多数 HUD 元素）"
LANGUAGE.option_simple_score_board					= "简化计分板（隐藏点数）"
LANGUAGE.option_play_music							= "播放背景音乐"
LANGUAGE.option_crosshair_while_ironsights			= "使用机械瞄准时显示准星"
LANGUAGE.option_crosshair_no_rotate					= "禁用准星旋转"
LANGUAGE.option_enable_color_correction				= "启用颜色校正"
LANGUAGE.option_enable_pain_flashes					= "启用疼痛特效"
LANGUAGE.option_show_ragdoll_eye_view				= "被击倒时切换至第三人称"
LANGUAGE.option_show_damage_indicators				= "显示伤害方位指示"
LANGUAGE.option_enable_view_roll					= "启用视角滚动"
LANGUAGE.option_always_show_nail_info				= "总是显示钉子信息"
LANGUAGE.option_weapon_hud_style					= "武器 HUD 风格"
LANGUAGE.option_music_volume						= "音乐音量"
LANGUAGE.option_ally_transparency_radius			= "队友透明化半径"
LANGUAGE.option_use_model_health_bar				= "使用高级的生命值显示器"

LANGUAGE.option_crosshair_color_primary				= "准星颜色 - 主要"
LANGUAGE.option_crosshair_color_secondary			= "准星颜色 - 次要"
LANGUAGE.option_health_color_full					= "生命值颜色 - 100%"
LANGUAGE.option_health_color_empty					= "生命值颜色 - 0%"

LANGUAGE.loser_points_added							= "由于团队失败，你获得了 %d 点数。"
LANGUAGE.winner_points_added						= "因为团队胜利，你获得了 %d 点数。"
LANGUAGE.draw_points_added							= "平局。你得到了 %d 点数。"
LANGUAGE.less_players_points_added					= "你的团队人数减少了，你获得了 %d 点数。"
...
LANGUAGE.shopitem_bodyarmor_name					= "防弹衣"
LANGUAGE.shopitem_bodyarmor_desc					= "购买时，穿戴额外的军用级防弹衣，其耐久度为 100 点，降低 25 点移动速度。\n这种防弹衣可以阻挡 75% 的爆炸伤害和 60% 的子弹和近战伤害。\n然而，它并不能保护头部，或者防御非物理的伤害，例如：有毒物质。\n受到防护降低的伤害会慢慢消耗护甲的耐久度。"
LANGUAGE.shopitem_bodyarmor_alreadyhave				= "你已经穿上防弹衣了。"

LANGUAGE.shopitem_adrenaline_name					= "肾上腺素"
LANGUAGE.shopitem_adrenaline_desc					= "购买时，注射肾上腺素，提高 20 点的移动速度，同时降低 10 点最大生命值。"
LANGUAGE.shopitem_adrenaline_toomuch				= "进一步使用肾上腺素是致命的。"

LANGUAGE.shopitem_ammo_name							= "弹药"
LANGUAGE.shopitem_ammo_desc							= "购买时，为当前持有的武器提供弹药。\n获得的弹药数量因武器而异，第一次购买的弹药数量也会不同。"
LANGUAGE.shopitem_ammo_invalid						= "此武器不能装填弹药。"
...
LANGUAGE.hm_mostenemykilled_name 					= "刺客"
LANGUAGE.hm_mostenemykilled_desc 					= "%s 杀死了 %d 个敌人。"
LANGUAGE.hm_mostdamagetoenemy_name 					= "好战份子"
LANGUAGE.hm_mostdamagetoenemy_desc 					= "%s 对敌人造成了共计 %d 点伤害。"
LANGUAGE.hm_pacifist_name 							= "和平主义"
LANGUAGE.hm_pacifist_desc 							= "%s 拒绝杀死一个敌人。"
LANGUAGE.hm_mosthelpful_name 						= "援助之手"
...
LANGUAGE.purchased_for_x_points						= "花费了 %d 点数完成购买。"
LANGUAGE.refunded_and_given_x_points				= "已退款 %d 点数。"
LANGUAGE.upgraded_for_x_points						= "花费了 %d 点数进行升级。"

LANGUAGE.require_x_more_points						= "还需要 %d 点数"
LANGUAGE.purchase_item								= "购买"
LANGUAGE.upgrade_item								= "升级"
LANGUAGE.revert_item								= "回退"
LANGUAGE.pointshop_title							= "点数商店"
LANGUAGE.pointshop_title_guns1						= "购买武器 1"
LANGUAGE.pointshop_title_guns2						= "购买武器 2"
LANGUAGE.pointshop_title_melee						= "购买近战武器"
LANGUAGE.pointshop_title_tools						= "购买工具"

LANGUAGE.x_points_abbreviated						= "%s 点数"

LANGUAGE.upgrade_to									= "升级至："
LANGUAGE.revert_to									= "回退至："
LANGUAGE.upgrading_x								= "正在升级 %s"
LANGUAGE.reverting_x								= "正在回退 %s"
LANGUAGE.switch_to_upgrade							= "切换至升级模式"
LANGUAGE.switch_to_revert							= "切换至回退模式"
...
LANGUAGE.prepare_yourself							= "准备好开始战斗..."
LANGUAGE.purchased_x_for_y_points					= "花费了 %d 点数购买了 %s！"
...
LANGUAGE.press_jump_to_free_roam					= "按“跳跃键”进入自由视角"
LANGUAGE.press_rmb_to_cycle_targets					= "按“鼠标右键”切换观察的对象"
LANGUAGE.press_duck_to_toggle_eyecam				= "按“下蹲键”切换第一人称/第三人称视角"
LANGUAGE.press_lmb_to_spawn							= "按“鼠标左键”重生"
LANGUAGE.you_respawned								= "你已重生。"
LANGUAGE.x_respawned								= "已重生"

LANGUAGE.respawn_after_x_seconds					= "%d 秒后重生..."
LANGUAGE.observing_x								= "正在观察：%s（%d）"
LANGUAGE.waiting_for_next_wave						= "等待下一波..."
...
LANGUAGE.all_dead									= "所有玩家已死亡。"

LANGUAGE.final_wave_sub								= "最后的战斗开始！"
...
LANGUAGE.points										= "点数："
LANGUAGE.next_wave_in_x								= "下一波将在 %s 秒后开始"
LANGUAGE.wave_ends_in_x								= "这一波将在 %s 秒后结束"
LANGUAGE.wave_x_of_y								= "第 %d/%d 波"
LANGUAGE.game_start_in_x							= "回合将在 %s 秒后开始"
LANGUAGE.intermission								= "中场休息"
LANGUAGE.breath										= "氧气"
...
LANGUAGE.warning									= "警告！"
LANGUAGE.ok_and_no_reminder							= "不再显示"

LANGUAGE.bandits_victory							= "土匪胜利"
LANGUAGE.bandits_victory_desc						= "土匪们将使世界陷入混乱。"
LANGUAGE.survivors_victory							= "求生者胜利"
...
LANGUAGE.credit_airrice_desc                        = "《土匪战争》程序员"
LANGUAGE.credit_jetboom                             = "William “JetBoom” Moodhe"
LANGUAGE.credit_jetboom_desc                        = "《僵尸生存》制作者/程序员"
...
LANGUAGE.credit_sunrust_community_desc              = "代码贡献"
LANGUAGE.credit_github                              = "GitHub 上的其他各位《僵尸生存》贡献者"
LANGUAGE.credit_github_desc                         = "各种贡献"

LANGUAGE.scoreboard_gamemode_author                 = "制作者：%s（%s）"

LANGUAGE.scoreboard_tag_jetboom                     = "JetBoom\n《僵尸生存》的制作者！"
LANGUAGE.scoreboard_tag_airrice                     = "air rice\n《土匪战争》程序员"
LANGUAGE.scoreboard_tag_admin                       = "管理员"

LANGUAGE.pointfloater_x_assisted                    = "%s（助攻）"
...
LANGUAGE.stat_meleerange							= "近战距离"

LANGUAGE.stat_clipsize								= "弹夹大小"
LANGUAGE.stat_defaultgiven							= "默认弹药数量"
LANGUAGE.stat_gundmg								= "伤害"
LANGUAGE.stat_numshots								= "每发子弹数"
LANGUAGE.stat_firedelay								= "攻击延迟"

LANGUAGE.team_desc_bandit							= "土匪也曾是幸存者，在僵尸病毒爆发后，他们利用新一代的武器和装备来对抗僵尸。然而，面对这场夺取自主权和统治其它幸存者的战争，他们能否取得胜利？"
LANGUAGE.team_desc_human							= "求生者是人类中的佼佼者，在僵尸病毒爆发后，他们成功击退了一波又一波的僵尸。并且最终建立了某种形式的文明社会。但与此同时，也有一些昔日的盟友转变为了反叛的掠夺者，面对这来自人类种族内部的威胁，他们能否生存下去？"
-- The help file... Quite big! I wouldn't blame you if you didn't translate this part.
LANGUAGE.help_cat_introduction						= "介绍"
LANGUAGE.help_cat_keys								= "按键"
LANGUAGE.help_cat_tips								= "提示"
...
[[<table>
  ...
  <tr>
    <td>生成菜单键</td>
    <td>Q</td>
    <td>打开武器配置菜单（传输模式）/打开商店（死亡竞赛模式）</td>
  </tr>
  <tr>
    <td>商店</td>
    <td>F2</td>
