...
LANGUAGE.weapon_drill_name							= "Cordless Drill"
LANGUAGE.weapon_drill_desc							= "This power tool with a screwdriver bit works like a hammer but at a much higher efficiency. Aside from the usual hammer usages, it can also repair barricades even when they can no longer be repaired by a hammer.\nIt can however overheat, which makes it difficult to use continuously for long periods at a time."
...
LANGUAGE.weapon_buststick_desc						= "This melee weapon has been fashioned out of a marble bust and a stick affixed to it.\nWhen the user is hit by a bullet that would have dealt at least 50 damage, the bust is hit by the shot instead and breaks.\nThe bust is repaired after 15 seconds, but while broken the weapon deals 50% additional slash damage."
LANGUAGE.weapon_greataxe_name						= "Crescent Axe"
LANGUAGE.weapon_greataxe_desc						= "This massive axe gives some protection against bullets to the wielder.\nThe wielder collects one defense stack by striking an enemy, and 3 defense stacks if the hit kills them.\nWhen the wielder is shot, they will gain damage reduction equal to the amount of stacks for 5 seconds, expending the stacks in the process.\nThis takes effect after body armor."
...
LANGUAGE.weapon_cookingpot_name						= "Cooking Pot"
LANGUAGE.weapon_cookingpot_desc						= "This pot can be used to cook up a delicious feast.\nHit enemies with it to knock meat out of them to collect.\nBy holding secondary attack, the wielder begins cooking, replenishing the health of allies nearby using up collected meat."
LANGUAGE.weapon_mechanicwrench_name					= "Mechanic's Wrench"
LANGUAGE.weapon_mechanicwrench_desc					= "A skilled technician armed with this wrench can upgrade a variety of deployables. This includes Manhacks, Drones, Turrets, Point Defence Lamps, and Forcefield Emitters.\nHold secondary attack to upgrade a deployable. The process takes 5 seconds.\nOnly one deployable can be put in an upgraded state by each mechanic, and the upgrade is removed if the deployable is packed up, destroyed, or loses its owner."
LANGUAGE.weapon_mechanicwrench_upgrade_manhack		= "Upgrade a Manhack into a Mansawer, increasing its health and damage done by 30% and causing bullets shot at it to be reflected off."
LANGUAGE.weapon_mechanicwrench_upgrade_drone		= "Upgrade a Drone into a Tank Drone, which has twice the health, and automatically fires gauss shots at nearby enemies."
LANGUAGE.weapon_mechanicwrench_upgrade_turret		= "Upgrade an Automated Turret into an MRL Turret, which replaces every third shot with a micro missile. The missile explodes on impact, also damaging nearby targets."
LANGUAGE.weapon_mechanicwrench_upgrade_spotlamp		= "Upgrade a Point Defence Lamp into a Protector Lamp, which will provide a 50 percent chance for players in its operating range to not take damage from any given bullet. The lamp will take damage per bullet negated in this way."
LANGUAGE.weapon_mechanicwrench_upgrade_forcefield	= "Upgrade a Force Field Emitter to a Regenerative Field Emitter, which will slowly heal barricades and allied players near the emitter. The field itself also becomes immune to EMP shots."
...
LANGUAGE.weapon_class_fastpistol					= "Low-damage pistols with high fire rates. Quirky weapons that may be unwieldy but can be terrifyingly effective in the hands of experienced users."
LANGUAGE.weapon_class_magnumpistol					= "High-power pistols that are also very accurate, at the cost of lower firing speed. The rifle's younger brother, effective at even long ranges."
LANGUAGE.weapon_class_splitpistol					= "Pistols built with special mechanisms to scatter their shots. Provides a large burst of damage but at the cost of accuracy."
LANGUAGE.weapon_class_shotgun						= "Guns that fire a wide spread of pellets. Powerful up close, but less effective at longer ranges."
LANGUAGE.weapon_class_autoshotgun					= "Shotguns modified to fire at full auto, firing much quicker but at the cost of per-shot damage."
LANGUAGE.weapon_class_assault						= "Good all-rounders with comparatively high accuracy and damage, while also remaining full auto. Some higher-tier assault rifles are armed with scopes. Designed to be used from a standstill, and will be less accurate while on the move."
LANGUAGE.weapon_class_smg							= "Full-auto firearms which fire rapidly, but have low accuracy. Their accuracy is less affected by movement than assault rifles. High potential damage output at close ranges."
LANGUAGE.weapon_class_assaultsmg					= "An acceptable midpoint between assault rifles and smgs. Fire quickly similar to SMGs at assault rifle-like accuracies, but are a jack of all trades, master of none."
LANGUAGE.weapon_class_sniper						= "Powerful long-range rifles with pinpoint accuracy and scopes to aid in long range engagements. Best used by highly trained marksmen who can trust their accuracy."
LANGUAGE.weapon_class_marksman						= "A sidegrade of rifles which fire relatively quickly at full-auto. Still effective at long ranges, but each shot is less powerful. Designed for cases where getting a clear shot is not always possible."
LANGUAGE.weapon_class_crossbow						= "The premier projectile weapons. Each crossbow varies greatly in the properties of its shot, with effects such as lacerating flechettes causing bleeding or bouncing off solid surfaces. Unaffected by anti-bullet defenses, but are countered by point defence measures."
LANGUAGE.weapon_class_bio							= "Hideous amalgamations of zombie flesh and sinister technology. Fires zombie poison, which causes massive damage but heals quickly over time due to the zombie vaccine. However, the high burst damage will melt flesh and bone upon contact, leaving chunks of flesh. This flesh can be repurposed as ammunition by bioweapons."
LANGUAGE.weapon_class_pulse							= "Pulse weapons are a catch-all group consisting of many seemingly unrelated weapons, aside from their ammunition source. The true potential of pulse weaponry is found in the upgrade system, where most pulse weapons can be reached from any other pulse weapon. This allows for flexibility and a greater amount of choice."
LANGUAGE.weapon_class_medical						= "Dual-purpose weapons used to both heal allies and overdose enemies to cause damage over time. The exact mode of usage varies, but they can all be trusted to heal allies in some way. Much like Medical Kits, a sufficiently large amount of healing can even purge harmful status effects."
LANGUAGE.weapon_class_util							= ""

LANGUAGE.weapon_class_melee_blade					= "Knives, swords and other blades built to accommodate fast movement. All weapons in this line provide movement buffs or new modes of transport."
LANGUAGE.weapon_class_melee_debuff					= "Weapons which cause debilitating effects on the enemy. The exact form of harmful effect varies per weapon."
LANGUAGE.weapon_class_melee_defensive				= "Hefty weapons which help protect the user, usually from incoming bullets. They are useful when approaching a well-armed opponent."
LANGUAGE.weapon_class_melee_blunt					= "Clubs and hammers built for sheer damage potential. They are often slow to swing, but are devastating once they connect."
LANGUAGE.weapon_class_melee_blunt_fast				= "Weapons built for fast strikes. For those that prefer to hit faster and on the move than sheer force alone."
LANGUAGE.weapon_class_melee_repair					= "Repair tools which aid in the construction and maintenance of barricades and other deployables."
LANGUAGE.weapon_class_melee_util					= "Various construction and home implements which aid the user in some way."
