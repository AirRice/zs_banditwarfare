...
killicon.Add("killstreak", "vgui/achievements/hl2_kill_allc1709snipers", color_white)
...
killicon.AddFont("weapon_zs_combinesniper", "zsdeathnoticecs", "r", color_white)
...
killicon.AddFont("weapon_zs_nailgun", "zsdeathnotice", "-", color_white)
killicon.AddFont("weapon_zs_battleaxe", "zsdeathnoticecs", "c", color_white)
killicon.AddFont("weapon_zs_waraxe", "zsdeathnoticecs", "c", color_white)
...
killicon.AddFont("weapon_zs_rupture", "zsdeathnotice", "1", color_white)
killicon.AddFont("projectile_flechettearrow", "zsdeathnotice", "1", color_white)
...
killicon.AddFont("weapon_zs_tommy", "zsdeathnoticecs", "v", color_white)
...
killicon.Add("weapon_zs_medicalkit", "killicon/weapon_zs_medical", color_white)
killicon.Add("weapon_zs_medicgun", "killicon/weapon_zs_medical", color_white)
killicon.Add("weapon_zs_practition", "killicon/weapon_zs_medical", color_white)
