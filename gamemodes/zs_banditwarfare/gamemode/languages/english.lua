...
LANGUAGE.weapon_mechanicwrench_upgrade_spotlamp		= "Upgrade a Point Defence Lamp into a Protector Lamp, which will now also provide a defensive "
LANGUAGE.weapon_mechanicwrench_upgrade_forcefield	= "Upgrade a Force Field Emitter to a Barrier Field Emitter, which now reflects enemy bullets back as well as destroying enemy projectiles that pass through."
