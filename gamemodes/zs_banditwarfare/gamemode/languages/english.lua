...
LANGUAGE.weapon_mechanicwrench_upgrade_drone		= "Upgrade a Drone into a Tank Drone, which has twice the health, and periodically automatically fires explosive gauss shots at nearby enemies."
LANGUAGE.weapon_mechanicwrench_upgrade_turret		= "Upgrade an Automated Turret into an MRL Turret, which replaces every third shot with a micro missile. Micro missiles are projectiles that explode on impact, also damaging nearby targets."
...
LANGUAGE.weapon_mechanicwrench_upgrade_forcefield	= "Upgrade a Force Field Emitter to a Coating Field Emitter, which protects projectiles shot through from being intercepted and provides a damage reduction buff to allied players that pass through, reducing damage taken by up to 10 for 5 seconds."
...
LANGUAGE.weapon_class_assault						= "Good all-rounders with comparatively high accuracy and damage, while also remaining full auto. Designed to be used from a standstill, and will be less accurate while on the move."
LANGUAGE.weapon_class_smg							= "Full-auto firearms which fire rapidly, but have low accuracy. Accuracy is less affected by movement than assault rifles. High potential damage output at close ranges."
LANGUAGE.weapon_class_assaultsmg					= "An acceptable midpoint between assault rifles and smgs. Fire quickly similar to SMGs at assault rifle-like accuracies. Jack of all trades, master of none."
...
LANGUAGE.weapon_class_marksman						= "Sidegrade of rifles. Fire relatively quickly at full-auto. Still effective at long ranges, but each shot is less powerful. For when continuous saturated fire is more valuable."
LANGUAGE.weapon_class_crossbow						= "The premier projectile weapons. Each crossbow varies greatly in the properties of their bolts, such as causing bleeding or impaling through targets. Unaffected by anti-bullet defenses, but are countered by point defence measures."
LANGUAGE.weapon_class_bio							= "Hideous amalgamations of zombie flesh and technology. Fires zombie poison, which causes massive burst damage but heals quickly over time due to the zombie vaccine. Zombie poison melts targets upon contact, leaving chunks of flesh. Flesh can be repurposed as ammunition by bioweapons."
LANGUAGE.weapon_class_pulse							= "A catch-all group consisting of many seemingly unrelated weapons, aside from their ammunition source. Utilises the upgrade system to its full potential by allowing a wide variety of weapons to be reached from any other pulse weapon. This allows for flexibility and a greater amount of choice."
LANGUAGE.weapon_class_medical						= "Dual-purpose weapons used to both heal allies and overdose enemies to cause damage over time. The exact mode of usage varies, but can all be trusted to heal allies in some way. Much like Medical Kits, a sufficiently large amount of healing can even purge harmful status effects."
