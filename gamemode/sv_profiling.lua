...
function GM:ProfilerPlayerValid(pl)
	...
	if not ((pl:Team() == TEAM_HUMAN or pl:Team() == TEAM_BANDIT)  and pl:Alive()
	...
	for _, ent in pairs(table.Merge(team.GetValidSpawnPoint(TEAM_BANDIT),team.GetValidSpawnPoint(TEAM_HUMAN))) do
