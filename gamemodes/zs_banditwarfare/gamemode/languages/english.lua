...
LANGUAGE.weapon_mechanicwrench_desc					= "A skilled technician armed with this wrench can upgrade a variety of deployables. This includes Manhacks, Drones, Turrets, Spotlamps, and Forcefield emitters.\nHold secondary attack to upgrade a deployable. The process takes 5 seconds.\nOnly one deployable can be upgraded at any given time by a single wielder."
