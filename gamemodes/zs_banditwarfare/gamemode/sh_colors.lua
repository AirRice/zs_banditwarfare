...
COLOR_LIGHTBLUE = Color(50, 180, 255)
...
COLOR_MAGENTA = Color(255, 10, 125)
COLOR_CORAL = Color(255, 80, 125)
COLOR_ORANGE = Color(255, 140, 60)
COLOR_AMBER = Color(255, 200, 60)
COLOR_VERMILLION = Color(255, 104, 60)

COLOR_DARKGRAY = Color(40, 40, 40)
COLOR_DARKRED = Color(185, 0, 0)
COLOR_DARKGREEN = Color(0, 150, 0)
COLOR_DARKBLUE = Color(15, 125, 150)
COLOR_DARKPURPLE = Color(185, 30, 185)
